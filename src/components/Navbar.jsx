...
const Navbar = () => {
    const {fetchImageByCategory, setQuery} = useContext(PixabayContaxt);
  return (
    <>
        ...
        <div className="container" style={{width:"800px"}}>
            <input type="text" className="form-control bg-dark text-light" onChange={(e) => setQuery(e.target.value)}></input>
        </div>
    </>
